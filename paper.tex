...
\caption{Input reflection coefficient \ensuremath{\Gamma_{\text{in}}} also known as \ensuremath{S_{\text{11}}} of the self-made backscattering ground-plane antenna.}
\label{fig:s11}
\end{figure} 
...
\ensuremath{Z_{\text{in}}=(52.2 + j 4.3) \Omega}. At 626 MHz
...
\begin{equation}
	\label{eq:nyquist}
	f_{\text{samp}} \geq 2 \cdot f_{\text{a}}
\end{equation}
\ensuremath{f_{\text{a}}} is the highest frequency in the signal.  A FIR filter
