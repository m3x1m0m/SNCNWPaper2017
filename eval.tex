...
\begin{figure}[h]
	...
	\end{minipage}
	\vspace{-6mm}
	\caption{\emph{Observed spectrum of television signal}. The left hand image shows rawspectrum of the TV signal with the centre frequency of \SI{626}{\mega\hertz}. The right hand image shows the smoothed spectrum, which is  normalized to maximum average. The average is  shown by the horizontal red line.}
	\label{fig:tv_record} 
		\vspace{-6mm}
\end{figure}
